...
// ตัวอย่าง 7 โพสต์ยอดนิยม (static)
$samplePosts = [
    ['title'=>'C105 新刊『Whiteout』サンプル','author'=>'みふじやまい💊新刊委託中','img'=>'assets/manga5-1.jpg','link'=>'c-read-manga.php','views'=>3821,'likes'=>512],
    ['title'=>'C105 【お知らせ】6周年＆新婚ミニ漫画','author'=>'色のん','img'=>'assets/manga4-1.jpg','link'=>'b-read-manga.php','views'=>4219,'likes'=>632],
...
<head>
  ...
  <title data-key="popular">ยอดนิยม | LightTooN</title>
...
<main class="main-content" style="padding:20px;">
  <h1 data-key="popular">ยอดนิยม</h1>

  <section class="strip" id="popular-list" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); gap:20px;">
  </section>
</main>
...
<script>
    ...
    document.addEventListener("click", function(e) {
        if (e.target.closest(".like-btn")) {
            e.preventDefault(); // กันไม่ให้กดแล้วเด้งไป link
